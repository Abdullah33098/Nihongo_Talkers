            ...
            {() => (
              <Form className="w-full max-w-[718px] flex flex-col gap-8">
                ...
                <div className="flex justify-between mt-8">
                  <button
                    type="button"
                    className="border border-[#5183F4] text-[#5183F4] px-8 py-3 rounded-full hover:bg-[#5183F4] hover:text-white transition"
                  >
                    戻る
                  </button>
                  <button
                    type="submit"
                    className="bg-[#5183F4] text-white px-10 py-3 rounded-full hover:bg-[#3b6de0] transition"
                  >
                    次
                  </button>
                </div>

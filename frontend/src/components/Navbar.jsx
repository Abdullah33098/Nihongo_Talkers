...
const Navbar = () => {
  ...
  const userMenu = (
    <Menu
      className="w-[180px] rounded-[8px] shadow-md"
      items={[
        {
          key: '1',
          label: (
    ...
    <div className="flex-1 overflow-y-auto px-[30px] py-[20px]">
      <div className="flex flex-col gap-8">
        {navItems.map((item, index) => (
          <div
            key={index}
            className="font-medium text-[26px] text-[#181A20] gap-[15px] flex items-center"
          >
